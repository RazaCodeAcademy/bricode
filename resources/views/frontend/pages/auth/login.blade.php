                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-6 align-items-center auth-bg px-2 p-lg-5 pt-5 pt-md-0">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto mt-5 mt-md-0">
                                <h2 class="card-title font-weight-bold mt-5"></h2>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('user.login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label for="login-password">Password</label><a href="{{ route('ForgetPasswordGet') }}"><small>Forgot Password?</small></a>
                                        </div>
                                ...
                                <p class="text-center mt-2"><span>New on our platform?</span><a href="{{ route('user.register.form') }}"><span>&nbsp;Create an account</span></a></p>
